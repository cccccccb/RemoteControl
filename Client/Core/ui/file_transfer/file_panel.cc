...
#include "Client/Core/ui/file_transfer/file_panel.h"
...
#include "Client/Core/ui/file_transfer/file_item_delegate.h"
#include "Client/Core/ui/file_transfer/file_list_model.h"
