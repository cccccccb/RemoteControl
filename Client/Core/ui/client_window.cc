...
#include "Client/Core/ui/client_window.h"
...
void ClientWindow::onUpdateCheckedFinished(const base::ByteArray& result)
{
    ...
    base::Version current_version(REMOTECONTROL_VERSION_MAJOR, REMOTECONTROL_VERSION_MINOR, REMOTECONTROL_VERSION_PATCH);
