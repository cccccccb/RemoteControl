...
#include "Host/Core/desktop_session_process.h"
...
#if defined(OS_LINUX)
const char16_t kDesktopAgentFile[] = u"RemoteControlDesktopAgent";
#endif

#if defined(OS_WIN)
// Name of the default session desktop.
const char16_t kDefaultDesktopName[] = u"winsta0\\default";
const char16_t kDesktopAgentFile[] = u"RemoteControlDesktopAgent.exe";
