...
#include "Host/Core/ui/host_main.h"
...
#include "Host/Core/ui/application.h"
#include "Host/Core/ui/check_password_dialog.h"
#include "Host/Core/ui/config_dialog.h"
#include "Host/Core/ui/main_window.h"
...
{
#if defined(OS_WIN)
    base::installFailureHandler(L"RemoteControlHost");
#endif
    ...
    LOG(LS_INFO) << "Version: " << REMOTECONTROL_VERSION_STRING;
    ...
    else if (command_line.hasSwitch(u"version"))
    {
        QMessageBox::information(
            ...
            QApplication::translate("Host", "Application version: %1.%2.%3.%4.")
                .arg(REMOTECONTROL_VERSION_MAJOR)
                .arg(REMOTECONTROL_VERSION_MINOR)
                .arg(REMOTECONTROL_VERSION_PATCH)
