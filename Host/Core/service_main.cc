...
#include "Host/Core/service_main.h"
...
#include "Host/Core/host_key_storage.h"
...
int hostServiceMain(int argc, char* argv[])
{
    ...
    {
        std::cout << REMOTECONTROL_VERSION_MAJOR << "." << REMOTECONTROL_VERSION_MINOR << "."
                  << REMOTECONTROL_VERSION_PATCH << "." << GIT_COMMIT_COUNT << std::endl;
    }
