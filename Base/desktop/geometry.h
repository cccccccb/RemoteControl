...
BASE_EXPORT std::ostream& operator<<(std::ostream& stream, const Rect& rect);
BASE_EXPORT std::ostream& operator<<(std::ostream& stream, const Point& point);
BASE_EXPORT std::ostream& operator<<(std::ostream& stream, const Size& size);
