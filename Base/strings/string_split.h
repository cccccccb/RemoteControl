...
BASE_EXPORT std::vector<std::string> splitString(std::string input,
                                     std::string separators,
                                     WhitespaceHandling whitespace,
                                     SplitResult result_type);

BASE_EXPORT std::vector<std::u16string> splitString(std::u16string input,
...
//     ...
BASE_EXPORT std::vector<std::string> splitStringView(std::string input,
                                              std::string separators,
                                              WhitespaceHandling whitespace,
                                              SplitResult result_type);

BASE_EXPORT std::vector<std::u16string> splitStringView(std::u16string input,
                                                 std::u16string separators,
                                                 WhitespaceHandling whitespace,
                                                 SplitResult result_type);
