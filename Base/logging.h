...
BASE_EXPORT bool initLogging(const LoggingSettings& settings = LoggingSettings());
...
BASE_EXPORT void shutdownLogging();

// Used by LOG_IS_ON to lazy-evaluate stream arguments.
BASE_EXPORT bool shouldCreateLogMessage(LoggingSeverity severity);
...
class BASE_EXPORT ErrorLogMessage
{
public:
...
BASE_EXPORT std::ostream& operator<<(std::ostream& out, const std::u16string& ustr);
